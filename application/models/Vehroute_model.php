...
class Vehroute_model extends MY_Model {
    ...
    public function getRoute($student_id=null, $id = null) {

        $this->db->select('current_address')->from('students');
    ...
    function check_data_exists($transportationline) {

        $this->db->where('transportationline', $transportationline);
