...
class Issuebook extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(["Bookcategory_model","Book_model","Class_model","Classsection_model"]);
    }
    ...
    {   
        ...
        $this->load->view('admin/issuebook/create', ['data'=>$data,"booklist"=>$listbook,"classlist"=>$classlist]);
    ...
    // get all section of class after selected

    public function getSection($id){
        
         try{
           $allsection=$this->Classsection_model->getDetailsByClassId($id);
         echo json_encode($allsection);
         }
         catch(Exception $e){
            echo $e->getMessage();
         }
