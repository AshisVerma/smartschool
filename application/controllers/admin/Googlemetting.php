...
class Googlemetting extends Admin_Controller {
    ...
    public function __construct() {
        parent::__construct();
          $this->load->model(["Googlemetting_model","Role_model"]);
    ...
    public function index() {
        ...
        $googlemetting=$this->Googlemetting_model->get();
        ...
        $this->load->view('admin/googlemetting/add', ['googlemetting'=>$googlemetting,"role"=>$role]);
