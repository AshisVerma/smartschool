...
class Webservice extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->library('api/mailer');
        $this->load->library(array('api/customlib', 'api/enc_lib'));
	
        $this->load->model(array('api/auth_model', 'api/route_model', 'api/student_model', 'api/setting_model', 'api/attendencetype_model', 'api/studentfeemaster_model', 'api/feediscount_model', 'api/teachersubject_model', 'api/timetable_model', 'api/user_model', 'api/examgroup_model', 'api/webservice_model', 'api/grade_model', 'api/librarymember_model', 'api/bookissue_model', 'api/homework_model', 'api/event_model', 'api/vehroute_model', 'api/timeline_model', 'api/module_model', 'api/paymentsetting_model', 'api/customfield_model', 'api/subjecttimetable_model', 'api/onlineexam_model', 'api/leave_model', 'api/chatuser_model', 'api/conference_model', 'api/syllabus_model', 'api/gmeet_model', 'api/category_model', 'api/student_edit_field_model', 'api/filetype_model', 'api/course_model' ));
    }
