    ...
    <div class="col-sm-6 col-md-6 col-lg-6">
          ...
          <div class="box box-primary add-study-year-box" >
                    <div class="box-header with-border">
                        <h3 class="box-title">Update Semester</h3>
                    </div>
                    <form id="form1" action="<?php echo site_url('admin/semester/update') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                           
                                 <input type="hidden" name="id" value="<?php echo $data['semester_data']->id?>">
                            ...
                            <div class="form-group">
                               ...
                               <select class="form-control" name="year">
                                ...
                                <?php foreach($data['year'] as $key=>$list){?>
                                 <option value="<?php echo $list['year']?>" <?php if($list['year']==$data['semester_data']->year) echo "selected";?>><?php echo $list['year']?></option>
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus="" id="name" name="name" placeholder="Semester Name" type="text" class="form-control"  value="<?php echo $data['semester_data']->name; ?>" />
