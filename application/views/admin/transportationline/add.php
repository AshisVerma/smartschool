    ...
    <div class="col-sm-4 col-md-4 col-lg-4">
          ...
          <div class="box box-primary add-transportation-box" >
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Transportation Line</h3>
                    </div>
                    <form id="form1" action="<?php echo site_url('admin/transportationline/add') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <?php echo $this->customlib->getCSRF(); ?> 
                                ...
                                <label for="exampleInputEmail1">Transportation Line</label><small class="req"> *</small>
                                  <input type="text" name="transportationline" class="form-control" placeholder="Transportation line">
                                ...
                                <label for="exampleInputEmail1">Pick up & Drop </label><small class="req"> *</small>
                                  <input type="text" name="drop_point" class="form-control" placeholder="Pick up & Drop">
                                <span class="text-danger"><?php echo form_error('studyclass'); ?></span>
                            </div>  
                                  </div>
...
<div class="col-md-12">
                                ...
                                <label for="exampleInputEmail1">Stop Time </label><small class="req"> *</small>
                                  <input type="text" name="stop_time" class="form-control" placeholder="Stop Time">
                                <span class="text-danger"><?php echo form_error('studyclass'); ?></span>
                            </div>  
                                  </div>
                       ...
                       <div class="box-body">
                            <div class="mailbox-messages table-responsive">
                                ...
                                <table class="table table-hover table-striped table-bordered example">
                                   ...
                                   <tbody> 
                                     <?php  if(!empty($transportationline)) ?>
                                      <?php foreach($transportationline as $key=>$list){?>
                                        <tr>
                                          <td><?php echo $key+1?></td>
                                          <td><?php echo  $list['transportation_area'] ?></td>
                                           <td><?php echo  $list['transportationline'] ?></td>
                                            <td><?php echo  $list['drop_point'] ?></td>
                                              <td><?php echo  $list['stop_time'] ?></td>
                                                <td><?php echo  $list['amount'] ?></td>
                                                  <td><?php echo  $list['fee_type'] ?></td>
                                          ...
                                          <td>
...

                                            {
                                              ...
                                              ?>
                                               <a class="badge badge-success p-2 p-font" style="padding: 6px 10px;background: green;color: white;font-size: 12px;border-radius: 3rem;" data-toggle="tooltip" title="Status Active" href="<?php echo base_url();?>admin/transportationline/status/<?php echo $list['id']?>">Active</a>
                                            ...
                                            ?>
                                             <a class="badge badge-success p-2 p-font" style="padding: 6px 10px;background: red;color: white;font-size: 12px;border-radius: 3rem;" data-toggle="tooltip" title="Status Deactive" href="<?php echo base_url();?>admin/transportationline/status/<?php echo $list['id']?>">Deactive</a>
                                            <?php
                                          }?>

                                          </td>
                                          <td>
                                            <a class="btn btn-success" data="<?php echo $list['id']?>" href="<?php echo base_url()?>admin/transportationline/edit/<?php echo $list['id']?>"><i class="fa fa-edit" ></i></a>
    ...
    $(".delete-btn").each(function(){
      $(this).click(function(e){
        ...
        $(".delete-confirm-btn").click(function(){
          ...
          window.location.href="<?php echo base_url()?>/admin/transportationline/delete/"+id;
        });
