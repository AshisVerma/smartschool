...
<div class="content-wrapper" style="min-height: 946px;">
  ...
  <section class="content">
    <button style="float: right;" class="btn btn-primary mb-3" onclick="window.location.href='<?php echo base_url()?>admin/guardian/list'"><i class="fa fa-list" style="margin-right: 5px;"></i>Guardian List</button>
    <br>
  <div class="row">
  ...
  <br>
          ...
          <div class="box box-primary add-classroom-box" >
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Guardian</h3>
                    </div>
                    <form id="form1" action="<?php echo site_url('admin/guardian/add') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <?php echo $this->customlib->getCSRF(); ?> 
                                ...
                                <label for="exampleInputEmail1">Profession</label><small class="req"> *</small>
                                 <textarea class="form-control" name="profession"></textarea>
                                <span class="text-danger"><?php echo form_error('studyclass'); ?></span>
                            </div>  
                                  </div>
