    ...
    <div class="col-sm-5 col-md-5 col-lg-5">
          ...
          <div class="box box-primary add-transportation-box" >
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Transportation Area/Block</h3>
                    </div>
                    <form id="form1" action="<?php echo site_url('admin/transportationarea/add') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-body">
                            <div class="mailbox-messages table-responsive">
                                ...
                                <table class="table table-hover table-striped table-bordered example">
                                   ...
                                   <tbody>
                                     <?php  if(!empty($transportationarea)) ?>
                                      <?php foreach($transportationarea as $key=>$list){?>
                                        <tr>
                                          ...
                                          <td>
...

                                            {
                                              ...
                                              ?>
                                               <a class="badge badge-success p-2 p-font" style="padding: 6px 10px;background: green;color: white;font-size: 12px;border-radius: 3rem;" data-toggle="tooltip" title="Status Active" href="<?php echo base_url();?>admin/transportationarea/status/<?php echo $list['id']?>">Active</a>
                                            ...
                                            ?>
                                             <a class="badge badge-success p-2 p-font" style="padding: 6px 10px;background: red;color: white;font-size: 12px;border-radius: 3rem;" data-toggle="tooltip" title="Status Deactive" href="<?php echo base_url();?>admin/transportationarea/status/<?php echo $list['id']?>">Deactive</a>
                                            <?php
                                          }?>
