...
?>
                    ...
                    <form method="post" action="<?php echo base_url('student/printmultiple') ?>">
                        <div class="box-header ptbnull"></div>
                            <div class="box-header ptbnull">
                                <button  class="btn btn-primary pull-right btn-sm checkbox-toggle printSelected" type="button" name="generate" title="generate multiple certificate"><?php echo $this->lang->line('print'); ?> <?php echo $this->lang->line('selected'); ?></button>
                            </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active table-responsive no-padding" id="tab_1">
                                ...
                                <table class="table table-striped table-bordered table-hover student-list"  id="student_list" data-export-title="<?php echo $this->lang->line('student') . " " . $this->lang->line('list'); ?>">
    ...
    $(document).ready(function () {
        $(document).on('click', '.printSelected', function () {
            ...
            if (array_to_print.length == 0) {
                ...
                $.ajax({
                    url: '<?php echo site_url("student/printmultiple") ?>',
                    type: 'post',
                    dataType: "html",
