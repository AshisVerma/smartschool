...
<select class="form-control transportationarea" id="vehroute_id" name="transportationarea">

<option value=""><?php echo $this->lang->line('select'); ?></option>
<?php
foreach ($transportationarea as $transportationarea_list) {
?>
<option><?php echo $transportationarea_list['name'] ?></option>
<?php
}
?>
</select>
...
<select class="form-control" name="transportation_line" class="transportationline">
...
<tr>
<td style="font-weight:bolder!important">Sub Total</td>
<td id="sub-total-price" style="font-weight:bolder !important;">0.00</td>
</tr>
...
//transportation on change event fire and get transportation line
$(document).ready(function(){
    $(".transportationarea").change(function(){
        var transportationarea=$(this).val();
        $.ajax({
            type:"GET",
            url:"<?php echo base_url()?>student/getTransportationLineDetails",
            data:{
...
//end transportation on change event fire and get transportation line
</script>
